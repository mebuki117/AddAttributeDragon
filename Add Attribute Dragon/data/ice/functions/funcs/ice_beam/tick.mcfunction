...
### dummy entity
## summon dummy entity
execute at @e[type=minecraft:dragon_fireball] run summon minecraft:bat ~ ~1 ~ {Invulnerable:true,NoAI:true,Silent:true,ActiveEffects:[{Id:14,Duration:2147483647,ShowParticles:false}],Team:"aad_i_beam"}
